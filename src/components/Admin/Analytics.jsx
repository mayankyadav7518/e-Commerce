  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
        {[
          { title: 'Total Revenue', value: '$124,580', change: '+12.5%', positive: true },
          { title: 'Total Orders', value: '8,429', change: '+18.2%', positive: true },
          { title: 'Average Order Value', value: '$148.20', change: '+5.4%', positive: true },
          { title: 'Conversion Rate', value: '3.24%', change: '-0.8%', positive: false },
        ].map((stat) => (
          <div
            key={stat.title}
          ...
          >
            ...
            >
              <span className="mr-1 text-lg">{stat.positive ? '↑' : '↓'}</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 mb-6 sm:mb-8">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-5 sm:p-6">
          ...
          <div className="h-64 sm:h-72 md:h-80 flex items-end justify-between gap-1 sm:gap-2">
            {['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'].map((month, i) => {
              const heights = [40, 55, 50, 70, 85, 90, 105, 120, 110, 130, 125, 140];
              return (
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-5 sm:p-6">
          ...
          <div className="space-y-5 sm:space-y-6">
            {[
              { category: "Men's Wear", amount: '$48,230', percent: 38.7, color: 'bg-teal-500' },
              { category: "Women's Wear", amount: '$52,180', percent: 41.9, color: 'bg-cyan-500' },
              { category: 'Accessories', amount: '$18,450', percent: 14.8, color: 'bg-purple-500' },
              { category: 'Footwear', amount: '$5,720', percent: 4.6, color: 'bg-orange-500' },
            ].map((cat) => (
              <div key={cat.category}>
                ...
                <p className="text-xs text-gray-500 mt-1">{cat.percent.toFixed(1)}% of total sales</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
          ...
          <div className="overflow-x-auto">
            <table className="w-full min-w-125">
              ...
              <tbody className="divide-y divide-gray-200">
                {[
                  { name: 'Premium Leather Jacket', sold: 320, revenue: '$79,680' },
                  { name: 'Summer Floral Dress', sold: 580, revenue: '$52,780' },
                  ...
                  <tr key={product.name} className="py-3 hover:bg-gray-50">
                    ...
                    <td className="py-3 text-center text-sm text-gray-900">{product.sold}</td>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-5 sm:p-6">
          ...
          <div className="space-y-5 sm:space-y-6">
            {[
              { source: 'Direct', visitors: '45,231', percent: 45.2, color: 'bg-teal-500' },
              { source: 'Google Search', visitors: '32,840', percent: 32.8, color: 'bg-cyan-500' },
              { source: 'Social Media', visitors: '14,220', percent: 14.2, color: 'bg-purple-500' },
              { source: 'Email Campaigns', visitors: '5,890', percent: 5.9, color: 'bg-orange-500' },
              { source: 'Referral', visitors: '1,890', percent: 1.9, color: 'bg-gray-500' },
            ].map((traffic) => (
              <div key={traffic.source}>
                <div className="flex flex-col sm:flex-row justify-between mb-2 gap-2">
                  <span className="text-sm font-medium text-gray-700">{traffic.source}</span>
