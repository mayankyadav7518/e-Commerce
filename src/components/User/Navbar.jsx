...
export default function Navbar() {
  ...
  const handleLogout = () => {
    // Add your real logout logic here (clear token, redux, etc.)
    setIsAccountOpen(false);
  ...
  return (
    <nav className="bg-white shadow-sm sticky top-0 z-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            <NavLink to="/user/men-products" className={navClass}>
              Men
            </NavLink>
            <NavLink to="/user/women-products" className={navClass}>
              Women
            </NavLink>
            <NavLink to="/user/kids-products" className={navClass}>
              Kids
            </NavLink>
            <NavLink to="/user/accessories" className={navClass}>
              Accessories
            </NavLink>
          </div>
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <div className="relative" ref={accountRef}>
              <button
                ...
                className="flex items-center gap-2.5 text-gray-700 hover:text-teal-700 transition-colors p-2 rounded-lg hover:bg-teal-50"
              ...
              {isAccountOpen && (
                <div className="absolute right-0 mt-3 w-72 bg-white rounded-xl shadow-2xl border border-gray-100 py-2 z-50">
                  <div className="flex items-center gap-2 border-b border-gray-400 pl-4 p-2">
                    <span>
                      <img
                  ...
                  <button
                    ...
                    className="flex items-center gap-3 w-full text-left px-5 py-3 text-red-600 hover:bg-red-50 transition-colors"
                  >
                    <LogOut size={18} />
                    Logout
                  </button>
      ...
      {/* Mobile Menu */}
      <div
        className={`md:hidden fixed overflow-y-auto inset-y-0 right-0 w-4/5 max-w-sm bg-white shadow-2xl transform transition-transform duration-300 ease-in-out z-50
        ...
        <div className="p-2 flex-1 overflow-y-auto">
          ...
          <div className=" border-t">
            <button
              ...
              className="w-full flex items-center justify-between px-5 py-3.5 text-gray-800 font-medium hover:bg-gray-50 rounded-lg transition-colors"
            >
